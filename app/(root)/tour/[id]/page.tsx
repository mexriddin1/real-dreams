                                      ...
                                      {r.title}
                                                                ...
                                                                >
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            className="md:col-span-2 prose max-w-none text-gray-600">
                                            ...
                                            {(tour.questions || []).map((q: TourQuestion) => {
                                                ...
                                                return (
                                                    <div key={q.id} className="">
                                                        ...
                                                        >
                                                            <div
                                                                className="text-base font-medium py-4 pl-4 text-left border-l-2 border-primary">
                                                                {q.question}
                                                            </div>
                                                            <div
                                                                className={`transform transition-transform duration-200 ${
                    ...
                    <aside className="lg:col-span-1">
                        ...
                        >
                            ...
                            <form className="mt-6 flex flex-col gap-3">
                                ...
                                <PeopleDropdown
                                    adults={Number(formData.people) || 0}
                                    isTour={true}
