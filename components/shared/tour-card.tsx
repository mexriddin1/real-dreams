...
function CardContent({
    ...
    return (
        <>
            <div
                className="rounded-2xl w-full sm:w-[600px] flex-shrink-0 sm:flex-shrink-0 snap-start overflow-hidden transition-shadow duration-150">
                <div className="relative h-[280px] sm:h-[380px]">
                    ...
                    {!isTopTour && (
                        <div
                            className="absolute bottom-3 right-3 bg-white text-primary px-4 py-4 font-medium rounded-full text-ms">
                            {price}$/{t("per_person")}
                        </div>
                    )}
                </div>
